  ...
  try {
    ...
    if (!reply && state.step === "TRACKING") {
      ...
      const answers: Record<string,string> = {
        ...
        sw: asksCorporate ? "Mipango ya Lueri ya biashara ni kwa mashirika na timu za biashara. Essential ni KES 25,000 kwa mwezi ikiwa na deliveries 5; Professional KES 45,000 ikiwa na 12; Elite KES 75,000 ikiwa na 25. Mikataba maalum ya Enterprise inapatikana juu ya Elite. Omba kupitia https://lueriinternational.com/corporate.html." :
