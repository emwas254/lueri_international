/* Copy update 2026-09-21: errands-first positioning + real prices (CBD KES 100, documents KES 200,
   errands from KES 400). Loaded after i18n-completion.js and before i18n.js, so it overrides the
   English and Swahili strings. Other languages keep their earlier translations except the first
   price, which is language-neutral. Edit prices HERE and in index.html when you re-price. */
(function () {
  ...
  merge(T.en = T.en || {}, en);
  merge(T.sw = T.sw || {}, sw);
  Object.keys(T).forEach(function (l) { if (l !== 'en') { T[l].pricing = T[l].pricing || {}; T[l].pricing.priceFrom = 'KES 100–200'; } });
})();