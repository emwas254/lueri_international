...
#lucy-launcher{display:block!important;position:fixed;right:24px;bottom:24px;z-index:2147483000;width:auto;min-width:190px;height:64px;padding:7px 17px 7px 7px;border:1px solid rgba(27,38,32,.18);border-radius:34px;background:#fffdf7;box-shadow:0 12px 34px rgba(27,38,32,.22);cursor:pointer;font-size:inherit;overflow:hidden;display:flex;align-items:center;gap:10px;transition:transform .2s ease,box-shadow .2s ease}#lucy-launcher:hover{transform:translateY(-2px);box-shadow:0 14px 34px rgba(0,0,0,.3)}#lucy-launcher .lucy-dot,#lucy-launcher [data-lucy-launcher-label]{display:none!important}#lucy-launcher .lucy-launcher-avatar{width:50px;height:50px;min-width:50px;border-radius:50%;background:url("${LUCY_AVATAR_SMALL}") center/cover no-repeat;border:2px solid #274238;box-shadow:0 2px 8px rgba(0,0,0,.16)}#lucy-launcher .lucy-launcher-copy{display:flex;flex-direction:column;align-items:flex-start;line-height:1.1;color:#1b2620}#lucy-launcher .lucy-launcher-title{font:800 15px/1.1 'IBM Plex Sans',sans-serif}#lucy-launcher .lucy-launcher-status{display:flex;align-items:center;gap:5px;margin-top:4px;font:500 11px/1.1 'IBM Plex Sans',sans-serif;opacity:.68}#lucy-launcher .lucy-online-dot{width:7px;height:7px;border-radius:50%;background:#2f8f55;box-shadow:0 0 0 3px rgba(47,143,85,.12)}
#lucy-panel{position:fixed;right:24px;bottom:100px;z-index:10001;width:min(500px,calc(100vw - 28px));height:min(690px,calc(100vh - 125px));display:none;flex-direction:column;overflow:hidden;background:#f0ead8;color:#1b2620;border:1px solid rgba(27,38,32,.2);border-radius:24px;box-shadow:0 24px 70px rgba(0,0,0,.28)}#lucy-panel.is-open{display:flex}.lucy-head{display:flex;align-items:center;justify-content:space-between;padding:16px 20px;background:#274238;color:#f0ead8;border-bottom:1px solid rgba(255,255,255,.12)}.lucy-head-main{display:flex;align-items:center;gap:12px}.lucy-avatar{width:54px;height:54px;min-width:54px;border-radius:50%;background:#e8b93d;background-image:url("${LUCY_AVATAR}");background-size:cover;background-position:center;border:2px solid #f0ead8;box-shadow:0 2px 10px rgba(0,0,0,.22);font-size:0;overflow:hidden}.lucy-title{font-weight:800;font-size:17px;line-height:1.1}.lucy-status{font-size:12px;opacity:.82;margin-top:5px}.lucy-close{border:0;background:transparent;color:inherit;font-size:30px;line-height:1;cursor:pointer;padding:2px 5px}.lucy-body{display:flex;flex-direction:column;min-height:0;flex:1}.lucy-messages{flex:1;overflow:auto;padding:20px;display:flex;flex-direction:column;gap:7px;scroll-behavior:smooth}.lucy-message{max-width:88%;padding:13px 15px;margin:3px 0;border-radius:17px;line-height:1.5;white-space:pre-wrap;overflow-wrap:anywhere;font-size:15px}.lucy-message.user{align-self:flex-end;background:#274238;color:#f0ead8;border-bottom-right-radius:5px}.lucy-message.bot{align-self:flex-start;background:#e7ece5;border:0;border-bottom-left-radius:5px}.lucy-typing{opacity:.65;font-style:italic}.lucy-topics{padding:0 20px 14px;display:flex;gap:9px;flex-wrap:wrap}.lucy-topic-btn{border:1px solid #1b2620;background:transparent;color:#1b2620;border-radius:999px;padding:9px 13px;font:600 12px/1.1 'IBM Plex Sans',sans-serif;cursor:pointer}.lucy-topic-btn:hover{background:#274238;color:#f0ead8}.lucy-compose{padding:14px 16px;border-top:1px solid rgba(27,38,32,.16);display:flex;gap:9px;background:#f0ead8}.lucy-input{flex:1;min-width:0;height:52px;border:1px solid rgba(27,38,32,.3);background:#fff;color:#1b2620;border-radius:28px;padding:0 17px;font:400 15px/1.3 'IBM Plex Sans',sans-serif}.lucy-input:focus{outline:2px solid #e8b93d;outline-offset:1px}.lucy-send{width:52px;height:52px;border:0;border-radius:50%;background:#1b2620;color:#fff;font-weight:800;cursor:pointer;font-size:0;display:grid;place-items:center}.lucy-send::before{content:'➤';font-size:20px;transform:translateX(1px)}.lucy-send:disabled{opacity:.55;cursor:not-allowed}.lucy-footer{display:none!important}@media(max-width:560px){#lucy-launcher{right:14px;bottom:14px;width:174px;min-width:174px;height:58px;padding:6px 13px 6px 6px}#lucy-launcher .lucy-launcher-avatar{width:46px;height:46px;min-width:46px}#lucy-launcher .lucy-launcher-title{font-size:14px}#lucy-launcher .lucy-launcher-status{font-size:10px}#lucy-panel{right:3px;bottom:3px;width:calc(100vw - 6px);height:calc(100vh - 6px);max-height:none;border-radius:22px}.lucy-head{padding:14px 16px}.lucy-avatar{width:48px;height:48px;min-width:48px}.lucy-messages{padding:15px}.lucy-topics{padding:0 15px 10px}.lucy-compose{padding:10px}}`;document.head.appendChild(s);}
