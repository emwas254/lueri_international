...
#lucy-launcher{display:flex!important;position:fixed;right:28px;bottom:24px;z-index:2147483000;width:166px;min-width:166px;height:54px;padding:5px 13px 5px 5px;border:1px solid rgba(240,234,216,.28);border-radius:30px;background:#274238;color:#f0ead8;box-shadow:0 12px 30px rgba(0,0,0,.24);cursor:pointer;align-items:center;gap:9px;transition:transform .18s ease,box-shadow .18s ease,background .18s ease;font-family:'IBM Plex Sans',Arial,sans-serif}#lucy-launcher:hover{transform:translateY(-2px);box-shadow:0 14px 34px rgba(0,0,0,.3)}#lucy-launcher .lucy-dot,#lucy-launcher [data-lucy-launcher-label]{display:none!important}#lucy-launcher .lucy-launcher-avatar{width:43px;height:43px;min-width:43px;border-radius:50%;background:url("${LUCY_AVATAR_SMALL}") center/cover no-repeat;border:2px solid #f0ead8;box-shadow:0 2px 7px rgba(0,0,0,.22)}") center/cover no-repeat;border:2px solid #274238;box-shadow:0 2px 8px rgba(0,0,0,.16)}#lucy-launcher .lucy-launcher-copy{display:flex;flex-direction:column;align-items:flex-start;line-height:1.1;color:#1b2620}#lucy-launcher .lucy-launcher-title{font:800 14px/1.1 'IBM Plex Sans',Arial,sans-serif;white-space:nowrap}#lucy-launcher .lucy-launcher-status{display:flex;align-items:center;gap:5px;margin-top:4px;font:500 11px/1.1 'IBM Plex Sans',sans-serif;opacity:.68}#lucy-launcher .lucy-online-dot{width:7px;height:7px;border-radius:50%;background:#2f8f55;box-shadow:0 0 0 3px rgba(47,143,85,.12)}
#lucy-panel{position:fixed;right:28px;bottom:88px;z-index:2147482999;width:370px;height:455px;display:none;flex-direction:column;overflow:hidden;background:#f0ead8;color:#1b2620;border:1px solid rgba(27,38,32,.2);border-radius:18px;box-shadow:0 22px 58px rgba(0,0,0,.27)}#lucy-panel.is-open{display:flex}.lucy-head{display:flex;align-items:center;justify-content:space-between;padding:12px 14px;background:#274238;color:#f0ead8;border-bottom:1px solid rgba(255,255,255,.12);min-height:70px}.lucy-head-main{display:flex;align-items:center;gap:12px}.lucy-avatar{width:47px;height:47px;min-width:47px;border-radius:50%;background:#e8b93d;background-image:url("${LUCY_AVATAR}");background-size:cover;background-position:center;border:2px solid #f0ead8;box-shadow:0 2px 8px rgba(0,0,0,.2);font-size:0;overflow:hidden}");background-size:cover;background-position:center;border:2px solid #f0ead8;box-shadow:0 2px 10px rgba(0,0,0,.22);font-size:0;overflow:hidden}.lucy-title{font-weight:800;font-size:17px;line-height:1.1}.lucy-status{font-size:12px;opacity:.82;margin-top:5px}.lucy-close{border:0;background:transparent;color:inherit;font-size:30px;line-height:1;cursor:pointer;padding:2px 5px}.lucy-body{display:flex;flex-direction:column;min-height:0;flex:1}.lucy-messages{flex:1;overflow:auto;padding:15px 16px 9px;display:flex;flex-direction:column;gap:6px;scroll-behavior:smooth}.lucy-message{max-width:88%;padding:10px 12px;margin:2px 0;border-radius:15px;line-height:1.4;white-space:pre-wrap;overflow-wrap:anywhere;font:400 13px/1.4 'IBM Plex Sans',Arial,sans-serif}.lucy-message.user{align-self:flex-end;background:#274238;color:#f0ead8;border-bottom-right-radius:5px}.lucy-message.bot{align-self:flex-start;background:#e7ece5;border:0;border-bottom-left-radius:5px}.lucy-typing{opacity:.65;font-style:italic}.lucy-topics{padding:0 20px 14px;display:flex;gap:9px;flex-wrap:wrap}.lucy-topic-btn{border:1px solid rgba(27,38,32,.65);background:transparent;color:#1b2620;border-radius:999px;padding:7px 10px;font:600 10.5px/1.1 'IBM Plex Sans',Arial,sans-serif;cursor:pointer}.lucy-topic-btn:hover{background:#274238;color:#f0ead8}.lucy-compose{padding:9px 11px;border-top:1px solid rgba(27,38,32,.14);display:flex;gap:8px;background:#f0ead8}.lucy-input{flex:1;min-width:0;height:43px;border:1px solid rgba(27,38,32,.25);background:#fff;color:#1b2620;border-radius:23px;padding:0 13px;font:400 13px/1.3 'IBM Plex Sans',Arial,sans-serif}.lucy-input:focus{outline:2px solid #e8b93d;outline-offset:1px}.lucy-send{width:43px;height:43px;border:0;border-radius:50%;background:#1b2620;color:#fff;font-weight:800;cursor:pointer;font-size:0;display:grid;place-items:center}.lucy-send::before{content:'➤';font-size:20px;transform:translateX(1px)}.lucy-send:disabled{opacity:.55;cursor:not-allowed}.lucy-footer{display:none!important}@media(max-width:560px){#lucy-launcher{right:14px;bottom:14px;width:160px;min-width:160px;height:50px;padding:4px 11px 4px 4px}#lucy-launcher .lucy-launcher-avatar{width:40px;height:40px;min-width:40px}#lucy-launcher .lucy-launcher-title{font-size:13px}#lucy-launcher .lucy-launcher-status{font-size:9.5px}#lucy-panel{right:14px;bottom:73px;width:min(360px,calc(100vw - 28px));height:min(445px,calc(100vh - 105px));border-radius:17px}.lucy-head{padding:11px 12px;min-height:64px}.lucy-avatar{width:43px;height:43px;min-width:43px}.lucy-messages{padding:13px 13px 8px}.lucy-topics{padding:0 12px 8px}.lucy-compose{padding:8px 9px}.lucy-input{height:41px}.lucy-send{width:41px;height:41px}}`;document.head.appendChild(s);}
